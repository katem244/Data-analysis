...
with open("/Users/kat/Documents/XCODE/graphPython/dataNewInterval.txt", "r") as f:
    data = f.read()
...
for item in range(0,interval):
    plt.axvline(x=sec, color='k', linestyle='-')
...
with open("/Users/kat/Documents/XCODE/graphPython/touchNewInterval.txt", "r") as f:
    data = f.read()
